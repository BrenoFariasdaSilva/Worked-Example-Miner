...
2. `DESIRED_HEADER` list constant refers to the desired header of the CSV file that will be passed to the `start_message` at the end of the script, so Gemini ain't flooded with unnecessary data.
