...
def prepare_context_message(csv_data):
	...
	'Refactoring Patterns' field, which is a list of refactoring patterns applied to the class. This were generated by the RefactoringMiner tool.

	With that in mind, i want you to analyze each line of the CSV and try to relate the terms of the method invocations with topics of Distributed Systems education, with good Refactoring Patterns related to code quality improvement by the vision of Software Engineering.
