...
def process_repository(repository_name, repository_url):
	...
	repositories_attributes = update_repository_attributes(repository_name, time.time() - start_time) if RRUN_FUNCTIONS["Repositories Attributes"] else None # Update the attributes of the repositories file with the elapsed time and output data size in GB
